...
| Tests | `pytest` (166, 92 % de cobertura) | `npm test` (12) |
| Lint | `ruff check .` | `npm run lint` |
| Detalle | [`backend/README.md`](backend/README.md) | `frontend/package.json` |

Sobre SQLite pasan 165 y se salta el de concurrencia del checkout, que necesita
PostgreSQL: `docker compose --profile test run --rm tests` corre los 166.
